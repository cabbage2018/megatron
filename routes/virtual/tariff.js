...
let log = log4js.getLogger('routes::virtual::tariff')
...
/// currently this program only support "aggregate energy through tag definition"
/// but virtual instrument would be an arbitrary equipment so it has specific IDentifiers
