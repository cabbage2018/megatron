...
class opcua {
    ...
    connect() {
        ...
        return new Promise(function (resolve, reject) {
            ...
            client.connect(that.endpointUrl, function (err) {
                if (err) {
                    reject(err)
                } else {
    ...
    commissioning(spaces) {
        ...
        var arr = [];
        for (var i = 0; i < that.spaces.nodeArray.length; i += 1) {
...
/*
    ...
    SOME DEVICE LIKE SIMOCODE PROV PN HAS VERY SMALL LIMIT;
    but SCADA has bigger
